        ...
        <button id="add_button">
            <svg class="svgIcon" viewBox="0 0 512 512">
                <g>
                    ...
                    c0,29.419-23.915,53.333-53.333,53.333H74.667c-29.419,0-53.333-23.915-53.333-53.333V128h469.333V437.333z" fill="#707070"/>
                </g>
                <g>
                    ...
                    c5.888,0,10.667-4.779,10.667-10.667v-74.667C362.667,47.851,314.816,0,256,0z" fill="#707070"/>
                </g>
                <g>
                    ...
                    c5.867,0,10.667,4.8,10.667,10.667C170.667,208.533,165.867,213.333,160,213.333z" fill="#707070"/>
                </g>
                <g>
                    ...
                    c5.867,0,10.667,4.8,10.667,10.667C362.667,208.533,357.867,213.333,352,213.333z" fill="#707070"/>
                </g>
            </svg>
        </button>
    </div>
...
//-------------- ARTICLE SORUCE CODE-------------
<article class="horizontal_flex">
        <input class="input_doble" type="text">
        ...
        <div class="button_area">
            ...
            <button id="delete_button">
                <svg class="svgIcon" viewBox="-10 -10 150 150">
                    <g>
                        <path d="M70.086,112.138c3.867,0,7.009-3.142,7.009-7.009V49.06c0-3.869-3.142-7.008-7.009-7.008
                            ...
                            c0-3.869-3.141-7.008-7.008-7.008s-7.009,3.14-7.009,7.008v56.069C84.104,108.996,87.245,112.138,91.112,112.138z" fill="#707070"/>
                    </g>
                </svg>
            </button>
        </div>
